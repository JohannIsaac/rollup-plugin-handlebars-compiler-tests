...
Handlebars.registerHelper('list', function(items, options) {
    var itemsAsHtml = items.map(function(item) {
...
const template = Handlebars.template({
    "1": function(container, depth0, helpers, partials, data) {
        ...
        return alias4(((helper = (helper = lookupProperty(helpers, "firstname") || (depth0 != null ? lookupProperty(depth0, "firstname") : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, {
                "name": "firstname",
                "hash": {},
                "data": data,
                "loc": {
    ...
    "main": function(container, depth0, helpers, partials, data) {
        ...
        return ((stack1 = (lookupProperty(helpers, "list") || (depth0 && lookupProperty(depth0, "list")) || container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}), (depth0 != null ? lookupProperty(depth0, "people") : depth0), {
            "name": "list",
            "hash": {},
