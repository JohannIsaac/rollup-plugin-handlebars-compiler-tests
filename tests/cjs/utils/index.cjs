...
var url = require('url');
var descriptionHelper = require('../samples/modules/descriptionHelper.cjs');

var _documentCurrentScript = typeof document !== 'undefined' ? document.currentScript : null;
var filepath = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('utils/index.cjs', document.baseURI).href)));
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    outputOptionsList_2 = tslib.__values(outputOptionsList), outputOptionsList_2_1 = outputOptionsList_2.next();
                    _b.label = 2;
                case 2:
...
exports.writeBundles = writeBundles;
